...
export default function Footer() {
  return (
    <footer className="relative font-main px-6 md:px-6 text-slate-600 pt-16 pb-10 bg-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl px-4 sm:px-6 mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
        <div>
          <h2 className="text-2xl font-bold text-black">PitchIQ</h2>
          ...
          <div className="mt-4 flex space-x-4 text-sm">
            <svg
              className="h-7 w-7 fill-current text-gray-500"
              role="img"
              viewBox="0 0 24 24"
      ...
      <div className="relative z-10 border-t px-6 md:px-6 border-gray-200 mt-12 pt-6 flex flex-col md:flex-row justify-between text-gray-500 text-sm font-medium  max-w-7xl mx-auto">
        <p>© {new Date().getFullYear()} PitchIQ All rights reserved</p>
