...
export default function NotFound() {
  return (
    <div className="min-h-screen font-main flex flex-col justify-center items-center bg-[radial-gradient(circle_at_bottom_left,_rgba(96,165,250,0.9),_transparent_46%)] text-center px-4">
      ...
      <Link href="/" className="mt-8 mx-4">
        <Button className="gap-2 px-12 py-6 min-w-[160px] text-base md:text-lg font-medium rounded-full bg-black shadow-lg me-2 mb-2">
